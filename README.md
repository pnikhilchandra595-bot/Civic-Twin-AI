...
- **Multi-Hazard Hydraulic Physics**: Simulates river overtopping, urban subway pooling, and storm surge across all 36 States & UTs (786+ Districts).
...
- **Multi-Lingual Guidance**: Multilingual disaster safety advice in English, Hindi, Marathi, Kannada, and Tamil.
...
### 6. 🔐 4-Tier Role-Based Clearance Hierarchy
- **Level 5 — National Authority (NDMA HQ)**: Unrestricted Pan-India control across all 36 States & UTs (786+ Districts) and Central Command.
- **Level 3 — State Sub-Officer (SDMA)**: Strictly locked to assigned State jurisdiction, CCTV feeds, and state district atlas.
- **Level 2 — District Sub-Officer (DDMA)**: Strictly locked to assigned District jurisdiction and municipal ward triage.
